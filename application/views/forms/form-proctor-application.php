<div class="info-form">
	...
	<?php echo form_open('/dbms/form_proctor_application'); ?>
		<div class="save">
		...
		<div class="form-inline">
			<div class="form-group">
				...
				<input type="number" class="form-control" name="landline" value="<?php echo set_value('landline'); ?>">
				<?php echo form_error('landline'); ?>
			</div>

			<div class="form-group">
				<label>Mobile Number</label>
				<input type="number" class="form-control" name="mobile_number" value="<?php echo set_value('mobile_number'); ?>">
