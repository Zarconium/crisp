<div class="info-form">
	...
	<h1><?php echo $this->mastertrainer->getMasterTrainerFullNameById($mastertrainer->Master_Trainer_ID)->Full_Name; ?></h1>

	<legend>Personal Information</legend>

	<?php echo form_open('/dbms/form_mastertrainer_profile/' . $mastertrainer->Master_Trainer_ID); ?>
		<div class="save">
		...
		<div class="form-inline">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="middle_initial" placeholder="Please put a '-' if there is no MI" value="<?php if(isset($mastertrainer->Middle_Initial)) echo $mastertrainer->Middle_Initial; ?>">
		...
		<div class="form-inline">
			<div class="form-group">
				...
				<input type="radio" name="gender" value="M" <?php if (!strcasecmp($mastertrainer->Gender, 'm')) { echo 'checked="checked"'; }?>> Male
				<input type="radio" name="gender" value="F" <?php if (!strcasecmp($mastertrainer->Gender, 'f')) { echo 'checked="checked"'; }?>> Female
		...
		<div class="form-inline">
			<div class="form-group">
				...
				<input type="number" class="form-control" name="landline" value="<?php if(isset($mastertrainer->Landline)) echo $mastertrainer->Landline; ?>">
				<?php echo form_error('landline'); ?>
			</div>

			<div class="form-group">
				<label>Mobile Number</label>
				<input type="number" class="form-control" name="mobile_number" value="<?php if(isset($mastertrainer->Mobile_Number)) echo $mastertrainer->Mobile_Number; ?>">
		...
		<div class="form-inline">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="facebook" value="<?php if(isset($mastertrainer->Facebook)) echo $mastertrainer->Facebook; ?>">
