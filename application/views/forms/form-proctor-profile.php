<div class="info-form">
	...
	<h1><?php echo $this->proctor->getProctorFullNameById($proctor->Proctor_ID)->Full_Name; ?></h1>

	<legend>Personal Information</legend>

	<?php echo form_open('/dbms/form_proctor_profile/' . $proctor->Proctor_ID); ?>
		<div class="save">
		...
		<div class="form-inline">
			<div class="form-group"><label>Gender</label><br/>
				<input type="radio" name="gender" value="M" <?php if (!strcasecmp($proctor->Gender, 'm')) { echo 'checked="checked"'; }?>> Male
				<input type="radio" name="gender" value="F" <?php if (!strcasecmp($proctor->Gender, 'f')) { echo 'checked="checked"'; }?>> Female
		...
		<div class="form-inline">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="facebook" value="<?php if(isset($proctor->Facebook)) echo $proctor->Facebook; ?>">
