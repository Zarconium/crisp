<?php include('header.php'); ?>
		...
		<div class="tab-content">
		  <div class="tab-pane active" id="student">
				  ...
				  <div class="col-md-12">
					  <div class="button-groups">
							<a href="form-student.php"><button type="submit" class="btn btn-primary">Add</button></a>
		  ...
		  <div class="tab-pane fade" id="trainer">
			  <div class="button-groups">
					<a href="form-trainer.php"><button type="submit" class="btn btn-primary">Add</button></a>
					<button class="btn btn-danger" data-toggle="modal" data-target="#delete">Delete</button>
				...
				<table class="table table-area">
					...
					<tr>
						<td><input type="checkbox"></td>
						<td><a href="form-trainer-edit.php">View</a> | <a href="#">Delete</a></td>
		  ...
		  <div class="tab-pane fade" id="program">
				...
				<ul class="nav nav-tabs">
				  ...
				  <li><a href="#gcat" data-toggle="tab">GCAT</a></li>
				...
				<div class="tab-content">
					...
					<div class="tab-pane active" id="class">
					  ...
					  <div class="button-groups">
							<a href="form-student-studentlist.php"><button type="submit" class="btn btn-primary">Add</button></a>
							<button class="btn btn-danger" data-toggle="modal" data-target="#delete">Delete</button>
